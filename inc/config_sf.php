...
//                                                                                    =======              =======
define(               'STR_LOCALE_SILLAJ', 'en');         // . default language       'fr', 'sv' or 'en'   'en'
...
define(          'STR_DB_USER_SILLAJ', 's130610rw');
define(          'STR_DB_PASS_SILLAJ', 'sillagedemo');
define(      'STR_DB_DATABASE_SILLAJ', 's130610_sillaj');
define(          'STR_DB_HOST_SILLAJ', 'mysql4-s');
/* </SOURCEFORGE> */
...
// a list of ISO 639-1 codes and language full names ; we should have at least the directories
// listed in the /lang/ folder
...
// <SOURCEFORGE>
define(         'FN_CACHE_SILLAJ', '/tmp/persistent/');
// </SOURCEFORGE>
define(   'STR_APPLI_NAME_SILLAJ', 'Sillaj');
define('STR_APPLI_VERSION_SILLAJ', '0.2.11');
define(       'STR_AUTHOR_SILLAJ', 'Michaël Delorme');
define( 'STR_AUTHOR_EMAIL_SILLAJ', 'sillaj@gmail.com');
define(     'URL_ROOT_DIR_SILLAJ', dirname($_SERVER['PHP_SELF']) .'/');
...
// <SOURCEFORGE>
// Add PEAR to the $PATH (sourceforge)
$fnPear = FN_ROOT_DIR_SILLAJ . 'lib/pear';
$includePath = ini_get('include_path');
ini_set('include_path', $includePath .":$fnPear");
session_save_path (FN_CACHE_SILLAJ);
//</SOURCEFORGE>
...
// Start Session and populate the $_SESSION variable with information on the user (name, lang, template...)
$user = new User;
...
$smarty->assign_by_ref(     'arrCss', $sillaj->getCss());
...
/**
 * Convert PHP date() format strings to a string usable for the javascript calendar. see /scripts/calendarPopup.js
 * ex '%d/%m/%Y' -> 'dd/mm/yyyy'
 ...
 * a UNIX timestamp into W3CDTF date format YYYY-MM-DDThh:mm:ssTZD eg: 2005-08-26T10:59:42+02:00
